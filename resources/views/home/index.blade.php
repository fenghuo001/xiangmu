...
@section('section')
        ...
        <div class="row first lazy">
                ...
                <div id="topic_scroll" class="topic-scroll slide">
                    <div class="carousel-inner">
                        ...
                        <div class="item">
                            <ul class="topic-list">
                                <li><a href="">
                                    <img alt="" src="/h_assets/img/advertise/focus-ban-5.jpg" /></a></li>
                                <li><a href="">
                                    <img alt="" src="/h_assets/img/advertise/focus-ban-5.jpg" /></a></li>
                                <li><a href="">
                                    <img alt="" src="/h_assets/img/advertise/focus-ban-5.jpg" /></a></li>
                        ...
                        <div class="item">
                            <ul class="topic-list">
                                <li><a href="">
                                    <img alt="" src="/h_assets/img/advertise/focus-ban-6.jpg" /></a></li>
                                <li><a href="">
                                    <img alt="" src="/h_assets/img/advertise/focus-ban-6.jpg" /></a></li>
                                <li><a href="">
                                    <img alt="" src="/h_assets/img/advertise/focus-ban-6.jpg" /></a></li>
            ...
            <div class="col-lg-2">
                <div class="mb10">
                    <img alt="" src="/h_assets/img/advertise/ad-right-1.jpg" />
                </div>
                <div class="mb10">
                    <img alt="" src="/h_assets/img/advertise/ad-right-2.jpg" />
                </div>
                <div class="mb10">
                    <img alt="" src="/h_assets/img/advertise/ad-right-3.jpg" />
                </div>
                <div class="mb10">
                    <img alt="" src="/h_assets/img/advertise/ad-right-4.jpg" />
                </div>
                <div>
                    <img alt="" src="/h_assets/img/advertise/ad-right-5.jpg" />
                </div>
            </div>
        </div>
        <!-- 第一行 轮播广告 结束 -->
            ...
            <div class="col-lg-12">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="new">
                        <ul class="listbar">
                            <li><a href="">
                                <img alt="" class="center-block" src="/h_assets/img/advertise/ad-2.jpg"></a>
        ...
        <div class="row mb10 lazy">
            ...
            <div class="col-lg-10">
                ...
                <div class="floor-product">
                    <ul class="listbar-2">
                        @foreach($jieri as $k=>$v)
                        <li><a href="">
                            <img alt="" class="center-block" src="/h_assets/img/advertise/ad-2.jpg"></a>
                            <div class="summary mt20"><a href="">{{$v->title}}</a></div>
                            <div class="price mt5">抢购价：<b>¥{{$v->spxj}}</b><i class="fr">送200优惠宝</i></div>
                        </li>
                        @endforeach
                    </ul>
        ...
        <div class="row mt10 lazy">
            <div class="col-lg-2">
                ...
                <div class="floor-brand">
                    <ul class="brand-list">
                        <li><a href="">
                            <img src="/h_assets/img/advertise/brand-1.jpg"></a></li>
                        <li><a href="">
                            <img src="/h_assets/img/advertise/brand-1.jpg"></a></li>
                        <li><a href="">
                            <img src="/h_assets/img/advertise/brand-1.jpg"></a></li>
                    ...
                    <a href="">
                        <img class="position" src="/h_assets/img/advertise/floor-2.jpg"></a>
                </div>
            </div>
            <div class="col-lg-8">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="fol-fir-1">
                        <ul class="listbar-3">
                            ...
                            <li><a href="">
                                <img alt="" class="center-block" src="/h_assets/img/advertise/ad-1.jpg"></a>
                                <div class="summary mt5">{{$v->title}}</div>
            ...
            <div class="col-lg-2">
                ...
                <div class="floor-ad">
                    <img src="/h_assets/img/advertise/floor-r-1.jpg">
                </div>
            </div>
        </div>
        <!-- 楼层2 我是美女结束 -->
